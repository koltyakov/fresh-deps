...
const { GoClient, matchesPrefixPatterns } = require('../out/registries/go');
const { NpmClient } = require('../out/registries/npm');
const npmrc = require('../out/npmrc');
const { PyPiClient } = require('../out/registries/pypi');
const { MavenClient } = require('../out/registries/maven');
const { NugetClient } = require('../out/registries/nuget');
...
function goEnvironment(t, privatePatterns, noProxyPatterns) {
...
for (const ecosystem of ['java', 'dotnet']) {
